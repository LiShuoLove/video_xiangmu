<?php
	...
	class AdvertisingController extends Controller
	{
		...
		public function index(Request $request)
		{
			...
			//保存搜索的条件
	        // $where = [];
	        $list = DB::table('data_video_AD')->get();
	        ...
	        // $list = $ob->paginate(3);
	        // dd($list)->all();
			return view ('admin.advertisings.advertising', compact('list'));
		}
		...
		{		
			...
			return view ('admin.advertisings.add');
		}
		...
		{
			return view ('admin.advertisings.edit');
		}
