...
<html lang="en">
   <head>
      ...
      <!--[if lt IE 8]>
      <link rel="stylesheet" href="{{ ('index/css/ie.css') }}" type="text/css" media="screen, projection">
      <![endif]-->
   ...
   <body>
               ...
               <aside class="dark-bg">
                  ...
                  <article class="reviews">
                     ...
                     <div class="post post-medium">
                        ...
                        <img src="{{ ('index/img/thumbs/thumb-review7.jpg') }}" class="review img-responsive" alt="Review">
                        </a>
                        <div class="infor">
                           <h4>
                  ...
                  <div class="col-lg-8 col-md-12 col-sm-12">
                     ...
                     <article class="page">
                        <div class="thumbr dropshd">
                           ...
                           <img class="img-responsive" src="{{ ('index/img/thumbs/page-img-thumb.jpg') }}" alt="#">
                           </a>
                        </div>
                        ...
                        <div class="video-content">
                           ...
                           <img src="{{ ('index/img/thumbs/page-img.jpg') }}" class="pull-left gap-right gap-bottom img-responsive" alt="img">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 post post-medium">
                           <div class="thumbr">
                              <a class="post-thumb" href="" data-lity title="Video Title Goes Here">
                                 ...
                                 <img class="img-responsive" src="{{ ('index/img/thumbs/thumb-s.jpg') }}" alt="#">
                              </a>
                           </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-6 post post-medium">
                           <div class="thumbr">
                              <a class="post-thumb" href="" data-lity title="Video Title Goes Here">
                                 <span class="play-btn-border" title="Play"><i class="fa fa-play-circle headline-round" aria-hidden="true"></i></span>
                                 <div class="cactus-note ct-time font-size-1"><span>02:02</span></div>
                                 <img class="img-responsive" src="{{ ('index/img/thumbs/thumb-s2.jpg') }}" alt="#">
                              </a>
                           </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-6 post post-medium">
                           <div class="thumbr">
                              <a class="post-thumb" href="" data-lity title="Video Title Goes Here">
                                 <span class="play-btn-border" title="Play"><i class="fa fa-play-circle headline-round" aria-hidden="true"></i></span>
                                 <div class="cactus-note ct-time font-size-1"><span>02:02</span></div>
                                 <img class="img-responsive" src="{{ ('index/img/thumbs/thumb-s4.jpg') }}" alt="#">
                              </a>
                           </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-6 post post-medium">
                           <div class="thumbr">
                              <a class="post-thumb" href="" data-lity title="Video Title Goes Here">
                                 <span class="play-btn-border" title="Play"><i class="fa fa-play-circle headline-round" aria-hidden="true"></i></span>
                                 <div class="cactus-note ct-time font-size-1"><span>02:02</span></div>
                                 <img class="img-responsive" src="{{ ('index/img/thumbs/thumb-s3.jpg') }}" alt="#">
                              </a>
                           </div>
                        </div>
                     </div>
      ...
      <script src="{{ ('index/js/jquery-1.12.1.min.js') }}"></script>
      <script src="{{ ('index/js/bootstrap.min.js') }}"></script>
      <script src="{{ ('index/js/lity.js') }}"></script>
      <script>
