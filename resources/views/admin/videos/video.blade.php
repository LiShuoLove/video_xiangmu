                       ...
                       <div class="am-form-group">
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-9">
                                  <div class="result_wrap">
                                    <div class="am-form-group am-form-file">
                                        <input type="text" size="50" name="video_movie" id="video_movie">
                                        <input id="video_upload" name="file_upload_movie" type="file" multiple="true">
                                        <p><video id="video1" alt="上传后显示视频"  style="max-width:350px;max-height:100px;" /></p>
                                    </div>
                                </div>
