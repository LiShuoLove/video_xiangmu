                    ...
                    <div class="widget-body am-fr">
                                ...
                                <form class="am-form tpl-form-border-form tpl-form-border-br" action="{{ url('admin/users') }}" method='post'>
                                                  {{ csrf_field() }}
                                    <div class="am-form-group">
                                        <label for="user-name" class="am-u-sm-3 am-form-label">用户id <span class="tpl-form-line-small-title">user_id</span></label>
                                        <div class="am-u-sm-9">
                                            <input type="text" class="tpl-form-input" id="" name='user_id' placeholder="请输入用户id">
                                    ...
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <input type="text" name='email' placeholder="输入您的电子邮箱">
                                        </div>
                                    </div>
                                    ...
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <input type="text" name='tel' placeholder="输入您的手机号">
                                        </div>
                                    </div>
                                    ...
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <input type="text" class="am-form-field tpl-form-no-bg" placeholder="生日时间" data-am-datepicker="" readonly="" name='birthday'>
                                            <small>生日时间必填</small>
                                        </div>
                                    </div>
                                    ...
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <input type="text" class="am-form-field tpl-form-no-bg" placeholder="注册时间" data-am-datepicker="" readonly="" name='created_at'>
                                            <small>注册时间必填</small>
                                        </div>
                                    </div>
                                    ...
                                    <div class="am-form-group">
                                        <div class="am-u-sm-9 am-u-sm-push-3">
                                            ...
                                            <input type="submit" class='am-btn am-btn-primary tpl-btn-bg-color-success ' value='添加用户'>
