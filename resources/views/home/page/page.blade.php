      ...
      <div id="single-page" class="container-fluid standard-bg">
               ...
               <nav class="navbar navbar-default">
                  ...
                  <div class="collapse navbar-collapse js-navbar-collapse megabg dropshd ">
                     <ul class="nav navbar-nav">
                        ...
                        <li><a href="{{ url('/posted') }}">视频贴</a></li>
                        <li><a href="{{ url('/page') }}">视频页</a></li>
         ...
         <div class="row">
            ...
            <div class="col-lg-2 col-md-4 hidden-sm hidden-xs">
               <aside class="dark-bg">
                  <article>
                     <h2 class="icon"><i class="fa fa-gears" aria-hidden="true"></i>观看排行</h2>
                  ...
                  <div class="col-lg-8 col-md-12 col-sm-12">
                     ...
                     <article class="page">
                        ...
                        <div class="video-content">
                           ...
                           <img src="{{ asset('homes/img/thumbs/page-img.jpg') }}" class="pull-left gap-right gap-bottom img-responsive" alt="img">
